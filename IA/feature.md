...
5. Flujo funcional
   Principal
   El Usuario web PGO invoca GET /api/v1/products.
   La API consulta todos los registros en product.
   Si hay uno o más registros, la API retorna 200 con la colección JSON.
   Si no hay registros, la API retorna 404 con error estándar.
   Alternos
